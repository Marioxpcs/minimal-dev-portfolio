const skills = {
  ...
  Databases: ["MongoDB", "Firebase", "PostgreSQL", "MySQL", "Supabase (pgvector)", "Redis"],
  "Cloud & DevOps": ["AWS Lambda", "S3", "RDS", "Docker", "Railway", "Heroku", "GitHub Actions"],
  "AI/ML": [
    "Claude API",
    "OpenAI API",
    "Cohere Embeddings",
  ...
  Tools: ["Git", "GitHub", "Figma", "Selenium WebDriver", "Postman"],
};
